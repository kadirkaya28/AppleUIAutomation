class TestData:
    ...
    ASSERTIONS = {
        ...
        "United Kingdom": {
            "main_title": "Apple (United Kingdom)",
            "menu_text": "iPhone",
